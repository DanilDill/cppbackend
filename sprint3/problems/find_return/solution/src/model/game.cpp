...
namespace model {
    ...
    void Game::Tick(std::chrono::milliseconds  ms)
    {
        ...
        // _loot_count = _lootGenerator->Generate(ms,_loot_count,_players.size());
    }
    ...
    const Game::LostObjects Game::getLostObjcets()
    {
        ...
        {
            const auto& session_obj =  session.second->GetLostObjects();
    ...
    void Game::SetDefaultBagCapacity(size_t capacity)
    {
